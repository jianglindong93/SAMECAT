...
def testMIOSTONE_mgs_only(tree_path, master_path, div, bmd_site, 
    ...
    torch.save(model.state_dict(), model_path + div + '_' + bmd_site + '_optparam_miostone_mgs_only_testing.pt')
...
summarized_results_cache.to_csv(summarized_results_path + bmd_site + '_miostone_mgs_only_summarized_results.csv', index=False)
